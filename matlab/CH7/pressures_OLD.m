...
% FL
subplot(8,5,1)
plot(old.volume(1,1:end),old.flow(1,1:end),'Color',colorBlack,'Linewidth',pt,'Linestyle','-'); hold on
...
for ii = 2:20
    subplot(8,5,ii)
    plot(old.volume(ii,1:end),old.flow(ii,1:end),'Color',colorBlack,'Linewidth',pt,'Linestyle','-'); hold on
