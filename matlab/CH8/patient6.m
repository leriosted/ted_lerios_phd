...
for ii = 1:length(breaths)
    ...
    P6(ii).Pes = Pes;
    P6(ii).PEEP = PEEP;
    P6(ii).insp_end = insp_end;
    P6(ii).r = r(2,1);
    P6(ii).RMSE = RMSE(ii,1);
    P6(ii).cc = cc(ii,1);
...
%     plot(T,Q,'Color',colorBlack,'Linewidth',0.4,'Linestyle',':')
    ...
    print('-r400','-dpng','Patient_6_ALL.png');
...
print('-r400','-dpng','Patient_6_cc.png');

save('Greek_data.mat','P6','-append')
