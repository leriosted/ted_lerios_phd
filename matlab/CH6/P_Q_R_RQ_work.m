...
% young
subplot(4,4,1)
plot(young.time,young.pressure(young.index,:),'Color',colorBlue,'Linewidth',pt,'Linestyle','-'); hold on
plot(young.time(1:young.exp_point(young.index)-1),young.Peff_Array{1, young.index},'Color',colorRed,'Linewidth',pt,'Linestyle','-.')
plot(young.time,-young.R1insp(young.index)*young.flow(young.index,:),'Color',colorBlack,'Linewidth',pt,'Linestyle','--')
plot(young.time(young.exp_point(young.index):end),-young.resistance(young.index,young.exp_point(young.index):end).*young.flow(young.index,young.exp_point(young.index):end),'Color',colorRed,'Linewidth',pt,'Linestyle','--')
xlabel('t (s)')
ylabel('P (cmH_2O)')
leg1 = legend('P_{alv}','P_{eff}','R_{1,insp} Q','R_{2} \Phi Q','FontSize',12,...
    'Orientation','horizontal');
legend boxoff
leg1.Position(1:2) = [.28 .24];
xlim(tlim)
ylim([-15 15])
grid on
set(gca,'FontSize',FS);
subplot(4,4,5)
plot(young.time,young.flow(young.index,:),'Color',colorBlue,'Linewidth',pt,'Linestyle','-'); hold on
xlabel('t (s)')
ylabel('Q (L/s)')
xlim(tlim)
ylim(qlim)
...
set(gca,'FontSize',FS);
subplot(4,4,9)
plot(young.time,young.volume(young.index,:),'Color',colorGreen,'Linewidth',pt,'Linestyle','-'); hold on
xlabel('t (s)')
ylabel('V (L/s)')
xlim(tlim)
ylim([0 1.8])
...
% old
subplot(4,4,2)
plot(old.time,old.pressure(old.index,:),'Color',colorBlue,'Linewidth',pt,'Linestyle','-'); hold on
plot(old.time(1:old.exp_point(old.index)-1),old.Peff_Array{1, old.index},'Color',colorRed,'Linewidth',pt,'Linestyle','-.')
plot(old.time,-old.R1insp(old.index)*old.flow(old.index,:),'Color',colorBlack,'Linewidth',pt,'Linestyle','--')
...
set(gca,'FontSize',FS);
subplot(4,4,6)
plot(old.time,old.flow(old.index,:),'Color',colorBlue,'Linewidth',pt,'Linestyle','-'); hold on
xlabel('t (s)')
ylabel('Q (L/s)')
xlim(tlim)
ylim(qlim)
...
set(gca,'FontSize',FS);
subplot(4,4,10)
plot(old.time,old.volume(old.index,:),'Color',colorGreen,'Linewidth',pt,'Linestyle','-'); hold on
xlabel('t (s)')
ylabel('V (L/s)')
xlim(tlim)
ylim([0 1.8])
...
% NFL
subplot(4,4,3)
plot(NFL.time,NFL.pressure(NFL.index,:),'Color',colorBlue,'Linewidth',pt,'Linestyle','-'); hold on
plot(NFL.time(1:NFL.exp_point(NFL.index)-1),NFL.Peff_Array{1, NFL.index},'Color',colorRed,'Linewidth',pt,'Linestyle','-.')
plot(NFL.time,-NFL.R1insp(NFL.index)*NFL.flow(NFL.index,:),'Color',colorBlack,'Linewidth',pt,'Linestyle','--')
...
set(gca,'FontSize',FS);
subplot(4,4,7)
plot(NFL.time,NFL.flow(NFL.index,:),'Color',colorBlue,'Linewidth',pt,'Linestyle','-'); hold on
xlabel('t (s)')
ylabel('Q (L/s)')
xlim(tlim)
ylim(qlim)
...
set(gca,'FontSize',FS);
subplot(4,4,11)
plot(NFL.time,NFL.volume(NFL.index,:),'Color',colorGreen,'Linewidth',pt,'Linestyle','-'); hold on
xlabel('t (s)')
ylabel('V (L/s)')
xlim(tlim)
ylim([0 1.8])
...
% FL
subplot(4,4,4)
plot(FL.time,FL.pressure(FL.index,:),'Color',colorBlue,'Linewidth',pt,'Linestyle','-'); hold on
plot(FL.time(1:FL.exp_point(FL.index)-1),FL.Peff_Array{1, FL.index},'Color',colorRed,'Linewidth',pt,'Linestyle','-.')
plot(FL.time,-FL.R1insp(FL.index)*FL.flow(FL.index,:),'Color',colorBlack,'Linewidth',pt,'Linestyle','--')
...
set(gca,'FontSize',FS);
subplot(4,4,8)
plot(FL.time,FL.flow(FLIndex,:),'Color',colorBlue,'Linewidth',pt,'Linestyle','-'); hold on
xlabel('t (s)')
ylabel('Q (L/s)')
xlim(tlim)
ylim(qlim)
...
set(gca,'FontSize',FS);
subplot(4,4,12)
plot(FL.time,FL.volume(FL.index,:),'Color',colorGreen,'Linewidth',pt,'Linestyle','-'); hold on
xlabel('t (s)')
ylabel('V (L/s)')
xlim(tlim)
ylim([0 1.8])
...
%        
if print_on ==1
    print('-r400','-dpng','P_Q_R_RQ_work.png');
else 
end
