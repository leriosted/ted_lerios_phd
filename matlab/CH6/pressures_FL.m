...
% FL
subplot(8,5,1)
plot(FL.time,FL.pressure(1,1:end),'Color',colorBlack,'Linewidth',pt,'Linestyle','-'); hold on
...
for ii = 2:35
    subplot(8,5,ii)
    plot(FL.time,FL.pressure(ii,1:end),'Color',colorBlack,'Linewidth',pt,'Linestyle','-'); hold on
...
if print_on ==1
    print('-r400','-dpng','pressuresFL.png');
else 
end
