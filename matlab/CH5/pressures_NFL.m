...
% FL
subplot(8,5,1)
plot(NFL.pressure(1,1:end),NFL.flow(1,1:end),'Color',colorBlack,'Linewidth',pt,'Linestyle','-'); hold on
...
for ii = 2:25
    subplot(8,5,ii)
    plot(NFL.pressure(ii,1:end),NFL.flow(ii,1:end),'Color',colorBlack,'Linewidth',pt,'Linestyle','-'); hold on
