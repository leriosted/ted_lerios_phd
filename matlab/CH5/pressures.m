...
% plot(young.time(1:young.exp_point(young.index)-1),-young.R1insp(young.index)*young.flow(1:young.exp_point(young.index)-1),'Color',colorBlack,'Linewidth',pt,'Linestyle','--')
