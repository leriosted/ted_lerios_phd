...
% FL
subplot(8,5,1)
plot(young.flow(1,1:end),young.resistance(1,1:end),'Color',colorBlack,'Linewidth',pt,'Linestyle','-'); hold on
...
for ii = 2:20
    subplot(8,5,ii)
    plot(young.flow(ii,1:end),young.resistance(ii,1:end),'Color',colorBlack,'Linewidth',pt,'Linestyle','-'); hold on
