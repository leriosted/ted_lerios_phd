...
% FL
subplot(8,5,1)
plot(young.pressure(1,1:end),young.flow(1,1:end),'Color',colorBlack,'Linewidth',pt,'Linestyle','-'); hold on
...
for ii = 2:20
    subplot(8,5,ii)
    plot(young.pressure(ii,1:end),young.flow(ii,1:end),'Color',colorBlack,'Linewidth',pt,'Linestyle','-'); hold on
