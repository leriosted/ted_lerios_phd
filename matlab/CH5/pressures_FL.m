...
% FL
subplot(8,5,1)
plot(FL.pressure(1,1:end),FL.flow(1,1:end),'Color',colorBlack,'Linewidth',pt,'Linestyle','-'); hold on
...
for ii = 2:35
    subplot(8,5,ii)
    plot(FL.pressure(ii,1:end),FL.flow(ii,1:end),'Color',colorBlack,'Linewidth',pt,'Linestyle','-'); hold on
