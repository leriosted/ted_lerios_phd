...
for ii = 1:length(breaths)
    ...
    P4(ii).Pes = Pes;
    P4(ii).PEEP = PEEP;
    P4(ii).insp_end = insp_end;
    P4(ii).r = r(2,1);
    P4(ii).RMSE = RMSE(ii,1);
    P4(ii).cc = cc(ii,1);
...
%     plot(T,Q,'Color',colorBlack,'Linewidth',0.4,'Linestyle',':')
    ...
    print('-r400','-dpng','Patient_4_ALL.png');
...
print('-r400','-dpng','Patient_4_cc.png');

save('Greek_data.mat','P4','-append')