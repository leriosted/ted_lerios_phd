...
for ii = 1:length(breaths)
    ...
    P3(ii).Pes = Pes;
    P3(ii).PEEP = PEEP;
    P3(ii).insp_end = insp_end;
    P3(ii).r = r(2,1);
    P3(ii).RMSE = RMSE(ii,1);
    P3(ii).cc = cc(ii,1);
...
%     plot(T,Q,'Color',colorBlack,'Linewidth',0.4,'Linestyle',':')
    ...
    print('-r400','-dpng','Patient_3_ALL.png');
...
print('-r400','-dpng','Patient_3_cc.png');

save('Greek_data.mat','P3','-append')
