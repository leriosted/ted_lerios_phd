...
for ii = 1:length(breaths)
    ...
    P5(ii).Pes = Pes;
    P5(ii).PEEP = PEEP;
    P5(ii).insp_end = insp_end;
    P5(ii).r = r(2,1);
    P5(ii).RMSE = RMSE(ii,1);
    P5(ii).cc = cc(ii,1);
...
%     plot(T,Q,'Color',colorBlack,'Linewidth',0.4,'Linestyle',':')
    ...
    print('-r400','-dpng','Patient_5_ALL.png');
...
print('-r400','-dpng','Patient_5_cc.png');

save('Greek_data.mat','P5','-append')
